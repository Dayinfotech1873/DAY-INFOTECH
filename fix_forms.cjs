          ...
          <div className="space-y-8">
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">આધાર નંબર (Aadhar)</label>
                  <input type="text" value={deathDetails.informerAadhar} onChange={(e) => setDeathDetails({ ...deathDetails, informerAadhar: e.target.value })} className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">આધાર નંબર (Aadhar)</label>
                  <input type="text" value={deathDetails.deathPersonAadhar} onChange={(e) => setDeathDetails({ ...deathDetails, deathPersonAadhar: e.target.value })} className="w-full bg-white border border-slate-300 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500" />
                </div>
                <div className="col-span-full">
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">કાયમી સરનામું (Permanent Address)</label>
...
if (startIndex !== -1 && endIndex !== -1) {
  code = code.substring(0, startIndex) + formContent + "\n        " + code.substring(endIndex);
  fs.writeFileSync('src/components/FormRenderer.tsx', code);
  console.log("Successfully replaced the forms.");
} else {
