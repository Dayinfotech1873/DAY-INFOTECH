  ...
  if (!currentUser) {
    return (
      <>
        ...
        <div className={`${activeTheme.bgClass} min-h-screen flex flex-col justify-center py-2 md:py-10 px-2.5 md:px-8 relative z-10`} style={activeTheme.bgStyle}>
        <div className="max-w-xl mx-auto w-full space-y-2.5 md:space-y-6">
