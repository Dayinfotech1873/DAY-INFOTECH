...
export const THEMES: Record<string, Theme> = {
  light: {
    ...
    nameEn: 'Light Theme',
    bgClass: 'min-h-screen bg-linear-to-b from-slate-50 to-slate-100 text-slate-800 antialiased py-3 md:py-4 px-2 md:px-3 relative pb-24',
  ...
  dark: {
    ...
    nameEn: 'Dark Theme',
    bgClass: 'min-h-screen bg-linear-to-b from-zinc-900 to-zinc-950 text-zinc-100 antialiased py-3 md:py-4 px-2 md:px-3 relative pb-24',
